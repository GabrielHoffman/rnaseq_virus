...
# Assemble contigs
Trinity.pl --seqType fq --JM 3G --CPU $NCPU --no_run_chrysalis --no_run_butterfly --single $FASTQ --output $WORK/trinity_inchworm
...
tophat -p $NCPU -o $WORK/trinity_inchworm_tophat_unmapped $WORK/trinity_inchworm/inchworm.K25.L25.DS $FASTQ
